  ...
  return (
       <div className='friend'>
            <div className='friend-image'>
                 ...
                 <a href={`./image/${fndInfo.image}`}><img src={`./image/${fndInfo.image}`} alt='' /></a>
                 {
     ...
     }
     {
          ...
          msgInfo && msgInfo.message.text && msgInfo.message.deleMsgMine!=="" ? <span className={ msgInfo?.senderId !== myId && msgInfo?.status !== undefined && msgInfo.status !== 'seen'?'unseen_message ' : '' }>{msgInfo.message.text.slice(0, 10)}</span> : msgInfo && msgInfo.message.image ? <span>Send A image </span> : <span>Connect You </span>
     }
